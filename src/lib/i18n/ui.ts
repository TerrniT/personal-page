...
export const ui = {
	en: {
		"home.title": "Home",
		"home.description": "I'm passionate about bringing ideas to life through code and technology. Whether it's building websites, apps, or software, I love the process of creating and sharing knowledge. I enjoy immersing myself in new topics and experiences, and I'm equally enthusiastic about teaching and sharing my expertise with others.",
	
		"home.heading": "Gleb Kotovsky (燕智, yànzhì)",
		"home.legenda": "燕 (yàn) - 'swallow (bird)', 智 (zhì) - 'wisdom, knowledge, intelligence'.",
		"home.paragraph": "I'm passionate about bringing ideas to life through code and technology. Whether it's building websites, apps, or software, I love the process of creating and sharing knowledge. I enjoy immersing myself in new topics and experiences, and I'm equally enthusiastic about teaching and sharing my expertise with others.",
		...
		"articles.description": "All of my long-form thoughts on programming, user interfaces, product design, and more, collected in chronological order",
	
		"articles.heading": "Articles",
		"articles.paragraph": "All of my long-form thoughts on programming, user interfaces, product design, and more, collected in chronological order",
	
		"articles.back_to": "Back to articles",

		"about.title": "About",
		"about.description": "I'm passionate about bringing ideas to life through code and technology. Whether it's building websites, apps, or software, I love the process of creating and sharing knowledge. I enjoy immersing myself in new topics and experiences, and I'm equally enthusiastic about teaching and sharing my expertise with others.",
	
		"about.heading": "About me",
		"about.paragraph": "I'm passionate about bringing ideas to life through code and technology. Whether it's building websites, apps, or software, I love the process of creating and sharing knowledge. I enjoy immersing myself in new topics and experiences, and I'm equally enthusiastic about teaching and sharing my expertise with others.",
		...
		"about.hard_skills.paragraph": "In my day-to-day work, I’m using a variety of technologies, including but not limited to the following:",
	...
	ru: {
		"home.title": "Главная",
		"home.description": "Я страстно люблю воплощать идеи в жизнь с помощью кода и технологий. Будь то создание веб-приложений, дизайна, анимаций или десктопных приложений, я люблю процесс создания и обмена знаниями. Мне нравится погружаться в новые темы и знания, и я с таким же энтузиазмом преподаю и делюсь своими знаниями с другими.",
	
		"home.heading": "Глеб Котовский (燕智, yànzhì)",
		"home.legenda": "燕 (yàn) - «ласточка (птица)», 智 (zhì) - «мудрость, знание, ум».",
		"home.paragraph": "Я страстно люблю воплощать идеи в жизнь с помощью кода и технологий. Будь то создание веб-приложений, дизайна, анимаций или десктопных приложений, я люблю процесс создания и обмена знаниями. Мне нравится погружаться в новые темы и знания, и я с таким же энтузиазмом преподаю и делюсь своими знаниями с другими.",
		...
		"articles.description": "Все мои размышления об IT, UI, дизайне продуктов и многом другом, собранные в хронологическом порядке",
	
		"articles.heading": "Статьи",
		"articles.paragraph": "Все мои размышления об IT, UI, дизайне продуктов и многом другом, собранные в хронологическом порядке",
	
		"articles.back_to": "Назад к статьям",


		"about.title": "Обо мне",
		"about.description": "Я страстно люблю воплощать идеи в жизнь с помощью кода и технологий. Будь то создание веб-приложений, дизайна, анимаций или десктопных приложений, я люблю процесс создания и обмена знаниями. Мне нравится погружаться в новые темы и знания, и я с таким же энтузиазмом преподаю и делюсь своими знаниями с другими.",
		"about.heading": "Обо мне",
		"about.paragraph": "Я страстно люблю воплощать идеи в жизнь с помощью кода и технологий. Будь то создание веб-приложений, дизайна, анимаций или десктопных приложений, я люблю процесс создания и обмена знаниями. Мне нравится погружаться в новые темы и знания, и я с таким же энтузиазмом преподаю и делюсь своими знаниями с другими.",
		...
		"about.hard_skills.paragraph": "В своей повседневной работе я использую различные технологии, включая, в частности, следующие:",
		...
		"contact.description": "Если есть вопросы, предложения, пожелания или просто хотите поговорить, то не стесняйтесь писать мне",
	
		"contact.heading": "Контакты",
		"contact.paragraph": "Если вы хотите связаться со мной по какому-то вопросу или просто пообщаться, то со мной можно связаться в соц. сетях или по почте.",
