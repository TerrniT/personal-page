...
export const ui = {
  en: {
    ...
    'projects.filters.description': 'Browse commercial and open-source work, then narrow the list by technology filters.',
    'projects.filters.trigger': 'Filter projects',
    'projects.filters.clear': 'Clear filters',
    'projects.filters.type': 'Project type',
    'projects.filters.stack': 'Technologies',
    'projects.filters.summary': 'Showing {visible} of {total} projects',
    'projects.empty.title': 'No projects found',
    'projects.empty.description': 'Try removing one or more filters to see more projects.',
    'projects.type.commercial': 'Commercial',
    'projects.type.open_source': 'Open source',
  ...
  ru: {
    ...
    'projects.filters.description': 'Здесь коммерческие и open source проекты. Сузить список можно по типу и технологиям.',
    'projects.filters.trigger': 'Фильтры проектов',
    'projects.filters.clear': 'Сбросить фильтры',
    'projects.filters.type': 'Тип проекта',
    'projects.filters.stack': 'Технологии',
    'projects.filters.summary': 'Показано {visible} из {total} проектов',
    'projects.empty.title': 'Проекты не найдены',
    'projects.empty.description': 'Попробуйте убрать один или несколько фильтров.',
    'projects.type.commercial': 'Коммерческие',
    'projects.type.open_source': 'Open source',
