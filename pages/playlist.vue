                  ...
                  >
                    <UiCarouselContent>
                      <UiCarouselItem
                        ...
                        class=" h-full"
                      >
                        <div class="px-5 py-6 h-[90px] rounded-[48px] items-start  flex flex-col">
                          <div class="flex gap-x-2 items-center">
                            ...
                            <div class="flex flex-col">
                              ...
                              <span class="!text-white text-sm">{{ item.artist }}</span>
                            </div>
                          </div>
                        </div>
                      </UiCarouselItem>
                ...
                >
                  ...
                  >
                    <IconsArrowLeft
                      ...
                      :class="carouselContainerRef[0].canScrollPrev ? 'fill-white' : 'fill-zinc-500'"
                    />
                  </UiButton>
                  <UiButton
                  ...
                  >
                    <IconsArrowRight
                      class="transition-all duration-200 ease-in-out"
                      :class="carouselContainerRef[0].canScrollNext ? 'fill-white' : 'fill-zinc-500'"
                    />
                  </UiButton>
                </div>
              </div>
              ...
              <div class="mt-2">
                <div class="flex justify-between items-start gap-x-2">
                  <div class="flex gap-x-1 items-center flex-wrap">
                    <h4 class="text-foreground font-semibold text-lg w-fit text-wrap">
                      {{ album.name }}
                    </h4>
                  </div>

                  <div class="text-muted-foreground mt-1 flex items-center w-10 justify-center bg-muted border border-muted-foreground/20 rounded-md text-xs text-center">
                    <span>
                      {{ album.year }}
                    </span>
                  </div>
